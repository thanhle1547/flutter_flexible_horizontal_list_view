...
void main() {
  testWidgets('HorizontalListView mount/dismount smoke test', (WidgetTester tester) async {
    ...
    // so if our widget is 100 pixels wide, it should fit exactly 8 times.
  ...
  testWidgets('HorizontalListView initial offset at 300 pixels', (WidgetTester tester) async {
    ...
    // but if we are offset by 300 pixels, there will be 4, numbered 1-5.
    ...
    scrollable.position.jumpTo(600.0); // now only 3 should fit, numbered 3-6.
  ...
  testWidgets('HorizontalListView initial offset at 500 pixels', (WidgetTester tester) async {
    ...
    // the root view is 800x600 in the test environment
    // so if our widget is 200 pixels wide, it should fit exactly 4 times.
    // but if we are offset by 500 pixels, there will be 5, numbered 1-6.
  ...
  testWidgets('HorizontalListView reinvoke builders', (WidgetTester tester) async {
    ...
    Widget builder() {
      return Directionality(
        textDirection: TextDirection.ltr,
        child: HorizontalListView.builder(itemBuilder: itemBuilder),
      );
    }
  ...
  testWidgets('HorizontalListView underflow extents', (WidgetTester tester) async {
    ...
    expect(
      ...
      equalsIgnoringHashCodes(
        'RenderUnconstrainedSliverList#00000 relayoutBoundary=up2\n'
        ' │ needs compositing\n'
        ' │ parentData: paintOffset=Offset(0.0, 0.0) (can use size)\n'
        ' │ constraints: SliverConstraints(AxisDirection.right,\n'
        ' │   GrowthDirection.forward, ScrollDirection.idle, scrollOffset:\n'
        ' │   0.0, precedingScrollExtent: 0.0, remainingPaintExtent: 800.0,\n'
        ' │   crossAxisExtent: 600.0, crossAxisDirection: AxisDirection.down,\n'
        ' │   viewportMainAxisExtent: 800.0, remainingCacheExtent: 1050.0,\n'
        ' │   cacheOrigin: 0.0)\n'
        ...
        ' │ │ constraints: BoxConstraints(0.0<=w<=Infinity, 0.0<=h<=600.0)\n'
        ...
        ' │   │\n'
        ' │   └─child: RenderLimitedBox#00000 relayoutBoundary=up5\n'
        ' │     │ parentData: <none> (can use size)\n'
        ' │     │ constraints: BoxConstraints(w=100.0, 0.0<=h<=600.0)\n'
        ' │     │ size: Size(100.0, 600.0)\n'
        ' │     │ maxWidth: 0.0\n'
        ' │     │ maxHeight: 0.0\n'
        ' │     │\n'
        ' │     └─child: RenderConstrainedBox#00000 relayoutBoundary=up6\n'
        ' │         parentData: <none> (can use size)\n'
        ' │         constraints: BoxConstraints(w=100.0, 0.0<=h<=600.0)\n'
        ' │         size: Size(100.0, 600.0)\n'
          ...
          child: SizedBox(
            ...
            child: HorizontalListView(
              ...
              children: const <Widget>[
                SizedBox(width: 140.0, child: text),
                SizedBox(width: 160.0, child: text),
                SizedBox(width: 80.0, child: text),
                SizedBox(width: 120.0, child: text),
                SizedBox(width: 90.0, child: text),
                SizedBox(width: 110.0, child: text),
                SizedBox(width: 80.0, child: text),
                SizedBox(width: 70.0, child: text),
              ],
            ),
          ),
        ),
